...
function drawStuff() {
    ...
    if (isAnimatingDrawing) {
        ...
        for (const object of animatedObjectsList) {
            ...
            const color = "rgba(" + (typeof lineColorRGB !== "undefined" ? lineColorRGB : "0, 0, 0") + ", " + opacity + ")";
        ...
        for (const [id, object] of objects) {
            const color = !object.selected ? "rgba(" + (typeof lineColorRGB !== "undefined" ? lineColorRGB : "0, 0, 0") + ", " + opacity + ")" : "rgba(0, 0, 255, " + timeSin.toString() + ")";
